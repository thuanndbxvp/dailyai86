...
try {
    ...
    echo "Đang đọc file gomhuong1_appnew.sql...<br>";
    $sql = file_get_contents(__DIR__ . '/gomhuong1_appnew.sql');
    
    if ($sql === false) {
        throw new Exception("Không tìm thấy file gomhuong1_appnew.sql");
    }
